...
\paragraph{解答.}
\begin{enumerate}[label=(\alph*), leftmargin=2.5em]
\item 令 $X=\{1,2,3\}$，定义 $X$ 上的关系 $R$ 为
\[
R=\{(1,1),(2,2),(3,3),(1,2),(2,1),(2,3),(3,2)\}.
\]
该关系是自反的，因为每个 $x\in X$ 都有 $(x,x)\in R$。它也是对称的，因为每条非自环边都同时包含反向边。然而它不是传递的，因为 $(1,2)\in R$ 且 $(2,3)\in R$，但 $(1,3)\notin R$。

\item 令 $X=\{1,2\}$，定义
\[
R=\{(1,1),(1,2),(2,2)\}.
\]
该关系是自反的，因为 $(1,1)$ 和 $(2,2)$ 都属于 $R$。它是传递的：唯一需要额外检查的非平凡组合是 $(1,2)$ 与 $(2,2)$，仍得到 $(1,2)\in R$；其他组合也都留在 $R$ 中。但它不是对称的，因为 $(1,2)\in R$，而 $(2,1)\notin R$。

\item 令 $X=\{1,2\}$，定义
\[
R=\{(1,1)\}.
\]
该关系是对称的，因为 $(1,1)$ 的反向仍是 $(1,1)$。它也是传递的，因为唯一可能的组合 $(1,1)$ 与 $(1,1)$ 仍推出 $(1,1)\in R$。但它不是自反的，因为在 $X$ 上自反要求 $(1,1)$ 和 $(2,2)$ 都属于 $R$，而 $(2,2)\notin R$。
\end{enumerate}
